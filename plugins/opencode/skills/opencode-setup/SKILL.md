---
name: opencode-setup
description: Check whether the local OpenCode CLI is ready and authenticated via the OpenCode companion. Use when the user asks for /opencode:setup or OpenCode setup.
user-invocable: true
---
...
```bash
node "<plugin-root>/scripts/opencode-companion.mjs" setup $ARGUMENTS
```
