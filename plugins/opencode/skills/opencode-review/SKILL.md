...
description: Run an OpenCode code review of the current git work via the OpenCode companion. Use when the user asks for /opencode:review or an OpenCode review.
user-invocable: true
---
