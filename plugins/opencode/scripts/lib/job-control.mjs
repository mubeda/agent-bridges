...
function inferLegacyJobPhase(job, progressPreview = []) {
  ...
  for (let index = progressPreview.length - 1; index >= 0; index -= 1) {
    ...
    if (line.startsWith("starting opencode") || line.startsWith("session ready") || line.startsWith("starting step") || line.startsWith("resuming opencode session")) {
      return "starting";
    }
